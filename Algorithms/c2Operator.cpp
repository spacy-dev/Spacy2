...
namespace Algorithm
{
  C2Operator::C2Operator(std::unique_ptr<Interface::AbstractC2Operator>&& impl)
    : C1Operator(std::unique_ptr<Interface::AbstractC1Operator>(impl.release()))
  {}
  ...
  {
    return dynamic_cast<const Interface::AbstractC2Operator&>( impl() ).d2(x.impl(),dx.impl(),dy.impl());
  }
}
