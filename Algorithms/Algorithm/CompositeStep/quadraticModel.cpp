...
namespace Algorithm
{
  namespace CompositeStep
  {
    namespace
    {
      auto quadraticCoefficients(double nu, const FunctionSpaceElement& dn, const FunctionSpaceElement& dt, const C2Functional &L, const FunctionSpaceElement& x)
      {
    ...
    Functions_1D::Quadratic makeQuadraticModel(double nu, const FunctionSpaceElement& dn, const FunctionSpaceElement& dt, const C2Functional &L, const FunctionSpaceElement& x)
    {
