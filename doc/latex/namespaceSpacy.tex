...
\begin{DoxyCompactList}\small\item\em Multiplication with arithmetic types (double,float,int,...). \end{DoxyCompactList}\item 
\hyperlink{classSpacy_1_1Vector}{Vector} \hyperlink{namespaceSpacy_a19486acb05af1627ec49c376b204a61c}{operator+} (\hyperlink{classSpacy_1_1Vector}{Vector} x, const \hyperlink{classSpacy_1_1Vector}{Vector} \&y)\hypertarget{namespaceSpacy_a19486acb05af1627ec49c376b204a61c}{}\label{namespaceSpacy_a19486acb05af1627ec49c376b204a61c}

\begin{DoxyCompactList}\small\item\em Sum of vectors $z=x+y$. \end{DoxyCompactList}\item 
\hyperlink{classSpacy_1_1Vector}{Vector} \hyperlink{namespaceSpacy_a9eaf4be1a4e8f3ee03e4c4fdafa5687d}{operator-\/} (\hyperlink{classSpacy_1_1Vector}{Vector} x, const \hyperlink{classSpacy_1_1Vector}{Vector} \&y)\hypertarget{namespaceSpacy_a9eaf4be1a4e8f3ee03e4c4fdafa5687d}{}\label{namespaceSpacy_a9eaf4be1a4e8f3ee03e4c4fdafa5687d}

\begin{DoxyCompactList}\small\item\em Subtract vectors $z=x-y$. \end{DoxyCompactList}\item 
\hyperlink{classSpacy_1_1Real}{Real} \hyperlink{namespaceSpacy_a1d84603fc2bfbefca6a020b1217519ad}{operator$\ast$} (const \hyperlink{classSpacy_1_1Vector}{Vector} \&x, const \hyperlink{classSpacy_1_1Vector}{Vector} \&y)\hypertarget{namespaceSpacy_a1d84603fc2bfbefca6a020b1217519ad}{}\label{namespaceSpacy_a1d84603fc2bfbefca6a020b1217519ad}

\begin{DoxyCompactList}\small\item\em Compute scalar product $z=x*y=(x,y)$. \end{DoxyCompactList}\item 
\hyperlink{classSpacy_1_1Real}{Real} \hyperlink{namespaceSpacy_a86a4fc266aa19a07b0af16388907354b}{norm} (const \hyperlink{classSpacy_1_1Vector}{Vector} \&x)\hypertarget{namespaceSpacy_a86a4fc266aa19a07b0af16388907354b}{}\label{namespaceSpacy_a86a4fc266aa19a07b0af16388907354b}
...
void {\bfseries check\+Dual\+Pairing} (const \hyperlink{classSpacy_1_1Vector}{Vector} \&x, const \hyperlink{classSpacy_1_1Vector}{Vector} \&y)\hypertarget{namespaceSpacy_ac354f06d21282619482e3ef4a841cd76}{}\label{namespaceSpacy_ac354f06d21282619482e3ef4a841cd76}
...
\item 
\hyperlink{classSpacy_1_1Real}{Real} {\bfseries operator$\ast$} (\hyperlink{classSpacy_1_1Real}{Real} y, const \hyperlink{classSpacy_1_1DampingFactor}{Damping\+Factor} \&x)\hypertarget{namespaceSpacy_aa07ac831672333d541a0853dcf42a6b0}{}\label{namespaceSpacy_aa07ac831672333d541a0853dcf42a6b0}

\item 
\hyperlink{classSpacy_1_1Real}{Real} {\bfseries operator$\ast$} (const \hyperlink{classSpacy_1_1LipschitzConstant}{Lipschitz\+Constant} \&x, \hyperlink{classSpacy_1_1Real}{Real} y)\hypertarget{namespaceSpacy_a81f372bdfa76c83a44edab9f33c2e8c8}{}\label{namespaceSpacy_a81f372bdfa76c83a44edab9f33c2e8c8}

\item 
\hyperlink{classSpacy_1_1Real}{Real} {\bfseries operator$\ast$} (\hyperlink{classSpacy_1_1Real}{Real} y, const \hyperlink{classSpacy_1_1LipschitzConstant}{Lipschitz\+Constant} \&x)\hypertarget{namespaceSpacy_a27fea9675330259cd5987d51798da16d}{}\label{namespaceSpacy_a27fea9675330259cd5987d51798da16d}
...
\index{Spacy@{Spacy}!Dynamic\+Callable\+Operator@{Dynamic\+Callable\+Operator}}
...
A time-\/dependent operator that does not know about domain and range spaces. \index{Spacy@{Spacy}!Callable\+Operator@{Callable\+Operator}}
...
An operator that does not know about domain and range spaces. Good enough for some algorithms (i.\+e. for Krylov-\/methods). \index{Spacy@{Spacy}!Norm@{Norm}}
...
\};
\end{DoxyCode}
 \index{Spacy@{Spacy}!Scalar\+Product@{Scalar\+Product}}
\index{Scalar\+Product@{Scalar\+Product}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{Scalar\+Product}{ScalarProduct}}]{\setlength{\rightskip}{0pt plus 5cm}using {\bf Spacy\+::\+Scalar\+Product} = typedef std\+::function$<${\bf Real}(const {\bf Vector}\&, const {\bf Vector}\&)$>$}\hypertarget{namespaceSpacy_aa995526aa0e3fa58aca8dd6772311cad}{}\label{namespaceSpacy_aa995526aa0e3fa58aca8dd6772311cad}
...
\index{Spacy@{Spacy}!d1@{d1}}
\index{d1@{d1}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{d1(const C1\+Operator \&\+A, const Vector \&x)}{d1(const C1Operator &A, const Vector &x)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Linear\+Operator} Spacy\+::d1 (
\begin{DoxyParamCaption}
\item[{const {\bf C1\+Operator} \&}]{A, }
\item[{const {\bf Vector} \&}]{x}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a2205e2a2c4bb5242665bbc09929d35d2}{}\label{namespaceSpacy_a2205e2a2c4bb5242665bbc09929d35d2}
...
\index{Spacy@{Spacy}!d1@{d1}}
\index{d1@{d1}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{d1(const C2\+Functional \&f, const Vector \&x)}{d1(const C2Functional &f, const Vector &x)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector} Spacy\+::d1 (
\begin{DoxyParamCaption}
\item[{const {\bf C2\+Functional} \&}]{f, }
\item[{const {\bf Vector} \&}]{x}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_ab6646eb7068eb9f1369e639cf0b620a2}{}\label{namespaceSpacy_ab6646eb7068eb9f1369e639cf0b620a2}
...
\end{DoxySeeAlso}
\index{Spacy@{Spacy}!d2@{d2}}
\index{d2@{d2}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{d2(const C2\+Functional \&f, const Vector \&x)}{d2(const C2Functional &f, const Vector &x)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Linear\+Operator} Spacy\+::d2 (
\begin{DoxyParamCaption}
\item[{const {\bf C2\+Functional} \&}]{f, }
\item[{const {\bf Vector} \&}]{x}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a569d8fc0b4a0e292f257dd6307a25c8f}{}\label{namespaceSpacy_a569d8fc0b4a0e292f257dd6307a25c8f}
...
\hyperlink{classSpacy_1_1C2Functional}{C2\+Functional} 
\end{DoxySeeAlso}
\index{Spacy@{Spacy}!make\+C\+G\+Solver@{make\+C\+G\+Solver}}
\index{make\+C\+G\+Solver@{make\+C\+G\+Solver}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{make\+C\+G\+Solver(\+Operator A, Callable\+Operator P, double relative\+Accuracy=1e-\/15, double eps=1e-\/15, bool verbose=false)}{makeCGSolver(Operator A, CallableOperator P, double relativeAccuracy=1e-15, double eps=1e-15, bool verbose=false)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+G\+::\+Linear\+Solver} Spacy\+::make\+C\+G\+Solver (
\begin{DoxyParamCaption}
\item[{{\bf Operator}}]{A, }
...
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_aafd9bf87164dd48991d2016aec8bad08}{}\label{namespaceSpacy_aafd9bf87164dd48991d2016aec8bad08}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!make\+R\+C\+G\+Solver@{make\+R\+C\+G\+Solver}}
\index{make\+R\+C\+G\+Solver@{make\+R\+C\+G\+Solver}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{make\+R\+C\+G\+Solver(\+Operator A, Callable\+Operator P, double relative\+Accuracy=1e-\/15, double eps=1e-\/15, bool verbose=false)}{makeRCGSolver(Operator A, CallableOperator P, double relativeAccuracy=1e-15, double eps=1e-15, bool verbose=false)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+G\+::\+Linear\+Solver} Spacy\+::make\+R\+C\+G\+Solver (
\begin{DoxyParamCaption}
\item[{{\bf Operator}}]{A, }
\item[{{\bf Callable\+Operator}}]{P, }
\item[{double}]{relative\+Accuracy = {\ttfamily 1e-\/15}, }
...
\item[{bool}]{verbose = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_af9ddae62858412fe5309d11aac7b8ed3}{}\label{namespaceSpacy_af9ddae62858412fe5309d11aac7b8ed3}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!make\+T\+C\+G\+Solver@{make\+T\+C\+G\+Solver}}
\index{make\+T\+C\+G\+Solver@{make\+T\+C\+G\+Solver}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{make\+T\+C\+G\+Solver(\+Operator A, Callable\+Operator P, double relative\+Accuracy=1e-\/15, double eps=1e-\/15, bool verbose=false)}{makeTCGSolver(Operator A, CallableOperator P, double relativeAccuracy=1e-15, double eps=1e-15, bool verbose=false)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+G\+::\+Linear\+Solver} Spacy\+::make\+T\+C\+G\+Solver (
\begin{DoxyParamCaption}
\item[{{\bf Operator}}]{A, }
\item[{{\bf Callable\+Operator}}]{P, }
\item[{double}]{relative\+Accuracy = {\ttfamily 1e-\/15}, }
...
\item[{bool}]{verbose = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a5693f62a60708a49f51cf451991b96ec}{}\label{namespaceSpacy_a5693f62a60708a49f51cf451991b96ec}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!make\+T\+R\+C\+G\+Solver@{make\+T\+R\+C\+G\+Solver}}
\index{make\+T\+R\+C\+G\+Solver@{make\+T\+R\+C\+G\+Solver}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{make\+T\+R\+C\+G\+Solver(\+Operator A, Callable\+Operator P, double relative\+Accuracy=1e-\/15, double eps=1e-\/15, bool verbose=false)}{makeTRCGSolver(Operator A, CallableOperator P, double relativeAccuracy=1e-15, double eps=1e-15, bool verbose=false)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C\+G\+::\+Linear\+Solver} Spacy\+::make\+T\+R\+C\+G\+Solver (
\begin{DoxyParamCaption}
\item[{{\bf Operator}}]{A, }
\item[{{\bf Callable\+Operator}}]{P, }
\item[{double}]{relative\+Accuracy = {\ttfamily 1e-\/15}, }
...
\item[{bool}]{verbose = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a66f5afbc97e887274b28be9c94aa3103}{}\label{namespaceSpacy_a66f5afbc97e887274b28be9c94aa3103}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!find\+Global\+Minimizer@{find\+Global\+Minimizer}}
\index{find\+Global\+Minimizer@{find\+Global\+Minimizer}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{find\+Global\+Minimizer(const std\+::function$<$ Real(const Real)$>$ \&f, Real a, Real b, Real eps=1e-\/2)}{findGlobalMinimizer(const std::function< Real(const Real)> &f, Real a, Real b, Real eps=1e-2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} Spacy\+::find\+Global\+Minimizer (
\begin{DoxyParamCaption}
\item[{const std\+::function$<$ {\bf Real}(const {\bf Real})$>$ \&}]{f, }
\item[{{\bf Real}}]{a, }
\item[{{\bf Real}}]{b, }
\item[{{\bf Real}}]{eps = {\ttfamily 1e-\/2}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_ae9be0a4a666a16ff296b87454f36956f}{}\label{namespaceSpacy_ae9be0a4a666a16ff296b87454f36956f}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!find\+Log\+Global\+Minimizer@{find\+Log\+Global\+Minimizer}}
\index{find\+Log\+Global\+Minimizer@{find\+Log\+Global\+Minimizer}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{find\+Log\+Global\+Minimizer(const std\+::function$<$ Real(const Real)$>$ \&f, Real a, Real b, Real eps=1e-\/2)}{findLogGlobalMinimizer(const std::function< Real(const Real)> &f, Real a, Real b, Real eps=1e-2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Real} Spacy\+::find\+Log\+Global\+Minimizer (
\begin{DoxyParamCaption}
\item[{const std\+::function$<$ {\bf Real}(const {\bf Real})$>$ \&}]{f, }
\item[{{\bf Real}}]{a, }
\item[{{\bf Real}}]{b, }
\item[{{\bf Real}}]{eps = {\ttfamily 1e-\/2}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a7ab93c587f9cb9951b26a8f07209c4cf}{}\label{namespaceSpacy_a7ab93c587f9cb9951b26a8f07209c4cf}
...
$ x \in \mathrm{argmin}_{[a,b]} $ 
\end{DoxyReturn}
\index{Spacy@{Spacy}!derivative@{derivative}}
\index{derivative@{derivative}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{derivative(\+C2\+Functional f)}{derivative(C2Functional f)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf C1\+Operator} Spacy\+::derivative (
\begin{DoxyParamCaption}
\item[{{\bf C2\+Functional}}]{f}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a002fe344fa6d04a6ac59a74ea25fddb6}{}\label{namespaceSpacy_a002fe344fa6d04a6ac59a74ea25fddb6}
...
$f'$ 
\end{DoxyReturn}
\index{Spacy@{Spacy}!make\+Real\+Space@{make\+Real\+Space}}
\index{make\+Real\+Space@{make\+Real\+Space}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{make\+Real\+Space(bool default\+Index=false)}{makeRealSpace(bool defaultIndex=false)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vector\+Space} Spacy\+::make\+Real\+Space (
\begin{DoxyParamCaption}
\item[{bool}]{default\+Index = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a4f4b05902653c5fc8d6411142dcb352f}{}\label{namespaceSpacy_a4f4b05902653c5fc8d6411142dcb352f}
...
\end{DoxyReturn}
\index{Spacy@{Spacy}!generic\+Copy@{generic\+Copy}}
\index{generic\+Copy@{generic\+Copy}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{generic\+Copy(const Origin \&x, Target \&y, std\+::function$<$ void(const Origin \&, Target \&)$>$ copy\+Target\+If\+Consistent)}{genericCopy(const Origin &x, Target &y, std::function< void(const Origin &, Target &)> copyTargetIfConsistent)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Origin , class Target $>$ void Spacy\+::generic\+Copy (
\begin{DoxyParamCaption}
\item[{const Origin \&}]{x, }
\item[{Target \&}]{y, }
\item[{std\+::function$<$ void(const Origin \&, Target \&)$>$}]{copy\+Target\+If\+Consistent}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a7dd8ce352c45e326cf8966befd5159ce}{}\label{namespaceSpacy_a7dd8ce352c45e326cf8966befd5159ce}


Copy from x to y. 

One of Origin or Target is a \hyperlink{classSpacy_1_1Vector}{Spacy\+::\+Vector}, the other is some other type. This function treats (nested) product space structures and uses copy\+Target\+If\+Consistent to copy single subspaces. \index{Spacy@{Spacy}!invoke@{invoke}}
\index{invoke@{invoke}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{invoke(\+Func \&\&func, Tup \&\&tup)}{invoke(Func &&func, Tup &&tup)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Func , typename Tup $>$ decltype(auto) Spacy\+::invoke (
\begin{DoxyParamCaption}
\item[{Func \&\&}]{func, }
\item[{Tup \&\&}]{tup}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a64250818ba7ff711c207af6ab40ff986}{}\label{namespaceSpacy_a64250818ba7ff711c207af6ab40ff986}
...
func(a0,a1,...) 
\end{DoxyReturn}
\index{Spacy@{Spacy}!create@{create}}
\index{create@{create}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{create(\+Tup \&\&tup)}{create(Tup &&tup)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Type , typename Tup $>$ decltype(auto) Spacy\+::create (
\begin{DoxyParamCaption}
\item[{Tup \&\&}]{tup}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_ae823c82326475d3cc3b166533deddf21}{}\label{namespaceSpacy_ae823c82326475d3cc3b166533deddf21}
...
Type(a0,a1,...) 
\end{DoxyReturn}
\index{Spacy@{Spacy}!connect\+As\+Primal\+Dual\+Pair@{connect\+As\+Primal\+Dual\+Pair}}
\index{connect\+As\+Primal\+Dual\+Pair@{connect\+As\+Primal\+Dual\+Pair}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{connect\+As\+Primal\+Dual\+Pair(\+Vector\+Space \&\+X, Vector\+Space \&\+Y)}{connectAsPrimalDualPair(VectorSpace &X, VectorSpace &Y)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spacy\+::connect\+As\+Primal\+Dual\+Pair (
\begin{DoxyParamCaption}
\item[{{\bf Vector\+Space} \&}]{X, }
\item[{{\bf Vector\+Space} \&}]{Y}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_a72844d3d381380c382cd9dce912e2664}{}\label{namespaceSpacy_a72844d3d381380c382cd9dce912e2664}
...
\hline
\end{DoxyParams}
Makes $X$ the primal space of $Y$ and makes $Y$ the dual space of $X$. This admits the evaluation of $y(x)$ for $x\in X$ and $y\in Y$. \index{Spacy@{Spacy}!check\+Space\+Compatibility@{check\+Space\+Compatibility}}
\index{check\+Space\+Compatibility@{check\+Space\+Compatibility}!Spacy@{Spacy}}
\subsubsection[{\texorpdfstring{check\+Space\+Compatibility(const Vector\+Space \&\+V, const Vector\+Space \&\+W)}{checkSpaceCompatibility(const VectorSpace &V, const VectorSpace &W)}}]{\setlength{\rightskip}{0pt plus 5cm}void Spacy\+::check\+Space\+Compatibility (
\begin{DoxyParamCaption}
\item[{const {\bf Vector\+Space} \&}]{V, }
\item[{const {\bf Vector\+Space} \&}]{W}
\end{DoxyParamCaption}
)}\hypertarget{namespaceSpacy_aae18423491adef608743902f1c40844e}{}\label{namespaceSpacy_aae18423491adef608743902f1c40844e}
