...
\begin{center}
\leavevmode
\includegraphics[width=256pt]{classSpacy_1_1GenericException__inherit__graph}
\end{center}
\end{figure}
...
\subsubsection[{\-Generic\-Exception}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-Spacy\-::\-Generic\-Exception\-::\-Generic\-Exception} (
