...
int main(int argc, char *argv[])
{
  ...
  std::function<NormalFunctionalDefinition(const typename Descriptions::VariableSet)> normalFuncGenerator = [&c,&d,&e,&alpha](const typename Descriptions::VariableSet y_ref) {
  ...
  std::function<TangentialFunctionalDefinition(const typename Descriptions::VariableSet)> tangentialFuncGenerator = [&c,&d,&e,&alpha](const typename Descriptions::VariableSet y_ref) {
