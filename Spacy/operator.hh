...
namespace Spacy
{
    ...
    */
    ...
    using MyOperator = std::function< Vector( const Vector&, const Vector& ) >;
    ...
    public:
        ...
        template < typename T,
                   typename std::enable_if< OperatorDetail::OperatorConcept<
                       Operator, typename std::decay< T >::type >::value >::type* = nullptr >
        Operator( T&& value )
            : functions_(
                  {&type_erasure_table_detail::clone_into_shared_ptr<
                       typename std::decay< T >::type >,
                   &type_erasure_table_detail::clone_into_buffer< typename std::decay< T >::type,
                                                                  Buffer >,
                   &OperatorDetail::execution_wrapper<
                       Operator, typename std::decay< T >::type >::call_const_Vector_ref,
