...
namespace Spacy
{
    ...
    namespace PPCG
    {
        ...
        public:
            ...
            * @param type solver type, i.e. "PPCG"
            */
            LinearSolver( Operator A_, CallableOperator P_, MyOperator proj, MyOperator r_update,
                          MyOperator lagr_update, const std::string& type = "PPCG" );
