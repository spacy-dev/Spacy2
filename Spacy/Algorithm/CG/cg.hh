...
namespace Spacy
{
    ...
    namespace CG
    {
        ...
        public:
            ...
            Solver( CallableOperator A, CallableOperator P, MyOperator r_update,
        ...
        private:
            ...
            /// Update regularization parameter \f$\theta\f$ in regularized conjugate gradient
            /// methods.
            void updateRegularization( Real qAq, Real qPq ) const;

            /// Replace \f$r\f$ with \f$ r - \alpha\theta\Pq \f$ in regularized conjugate gradient
            /// methods.
            void adjustRegularizedResidual( Real alpha, const Vector& Pq, Vector& r ) const;

            Vector get_w( const ::Spacy::Vector& r, const ::Spacy::Vector& g, const Real& beta,
