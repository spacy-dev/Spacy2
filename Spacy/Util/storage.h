...
namespace clang
{
    namespace type_erasure
    {
        namespace detail
        {
            ...
            void* copy_into_buffer( void* data, Buffer& buffer ) noexcept(
            ...
            template < class T, class Buffer >
            std::shared_ptr< void > copy_into_buffer(
                const std::shared_ptr< void >& data,
                Buffer& buffer ) noexcept( std::is_nothrow_copy_constructible< T >::value )
            {
                assert( data );
                new ( &buffer ) T( *static_cast< T* >( data.get() ) );
                return std::shared_ptr< T >( std::shared_ptr< T >(),
        ...
        public:
            constexpr explicit Accessor( std::size_t tile_id = 0,
                ...
                : contains_reference_wrapper( contains_ref_wrapper ), id( tile_id )
            {
            }
        ...
        public:
            ...
            template < class T,
                       std::enable_if_t< !std::is_base_of< Storage, std::decay_t< T > >::value >* =
                           nullptr >
            ...
            Storage( const Storage& other )
                : Accessor< Storage >( other ), del( other.del ), copy_data( other.copy_data ),
        ...
        public:
            ...
            template < class T, std::enable_if_t< !std::is_base_of<
                                    NonCopyableCOWStorage, std::decay_t< T > >::value >* = nullptr >
            explicit NonCopyableCOWStorage( T&& value )
                : Accessor< NonCopyableCOWStorage >(
        ...
        public:
            ...
            explicit SBOStorage( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
                    std::is_nothrow_copy_constructible< std::decay_t< T > >::value ) ) )
                : Accessor< SBOStorage< buffer_size > >(
                      typeid( std::decay_t< T > ).hash_code(),
                      detail::IsReferenceWrapper< std::decay_t< T > >::value ),
            ...
            template < class T, std::enable_if_t< !std::is_base_of<
                                    SBOStorage, std::decay_t< T > >::value >* = nullptr >
            SBOStorage& operator=( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
        ...
        public:
            ...
            template < class T, std::enable_if_t< !std::is_base_of<
                                    NonCopyableSBOStorage, std::decay_t< T > >::value >* = nullptr >
            explicit NonCopyableSBOStorage( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
                    std::is_nothrow_copy_constructible< std::decay_t< T > >::value ) ) )
                : Accessor< NonCopyableSBOStorage< buffer_size > >(
                      typeid( std::decay_t< T > ).hash_code(),
                      detail::IsReferenceWrapper< std::decay_t< T > >::value ),
                  function_table{&detail::delete_data< std::decay_t< T > >,
                                 &detail::destruct_data< std::decay_t< T > >}
            ...
            template < class T, std::enable_if_t< !std::is_base_of<
                                    NonCopyableSBOStorage, std::decay_t< T > >::value >* = nullptr >
            NonCopyableSBOStorage& operator=( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
        ...
        class SBOCOWStorage : public Accessor< SBOCOWStorage< buffer_size > >
        {
            ...
            struct FunctionTable
            {
                using destruct_fn = void ( * )( void* );
                using copy_fn = std::shared_ptr< void > ( * )( const std::shared_ptr< void >& );
                using buffer_copy_fn =
                    std::shared_ptr< void > ( * )( const std::shared_ptr< void >&, Buffer& );
        ...
        public:
            ...
            explicit SBOCOWStorage( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
                    std::is_nothrow_copy_constructible< std::decay_t< T > >::value ) ) )
                : Accessor< SBOCOWStorage< buffer_size > >(
                      typeid( std::decay_t< T > ).hash_code(),
                      detail::IsReferenceWrapper< std::decay_t< T > >::value ),
            ...
            template < class T, std::enable_if_t< !std::is_base_of<
                                    SBOCOWStorage, std::decay_t< T > >::value >* = nullptr >
            SBOCOWStorage& operator=( T&& value ) noexcept(
                sizeof( std::decay_t< T > ) <= sizeof( Buffer ) &&
                ( ( std::is_rvalue_reference< T >::value &&
                    std::is_nothrow_move_constructible< std::decay_t< T > >::value ) ||
                  ( std::is_lvalue_reference< T >::value &&
        ...
        //        template <int buffer_size>
        //        class NonCopyableSBOCOWStorage : public Accessor<
        //        NonCopyableSBOCOWStorage<buffer_size> >
        //        {
        //            static const constexpr bool always_copy = false;
        //            static const constexpr bool move_heap_allocated = true;
        //            using Buffer = std::array<char,buffer_size>;
        ...
        //            template <class T,
        //                      std::enable_if_t<!std::is_base_of<NonCopyableSBOCOWStorage,
        ...
        //                        (std::is_lvalue_reference<T>::value &&
        //                        std::is_nothrow_copy_constructible<std::decay_t<T>>::value) ) )
        //                : Accessor< NonCopyableSBOCOWStorage<buffer_size>
        //                >(typeid(std::decay_t<T>).hash_code(),
        //                                                         detail::IsReferenceWrapper<
        //                                                         std::decay_t<T> >::value),
