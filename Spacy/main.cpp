...
//#include "Spacy/ConjugateGradients/cg.hh"
//#include "FunctionSpaces/Spacy/vectorSpace.hh"
//#include "FunctionSpaces/Spacy/vectorSpaceElement.hh"
//#include "FunctionSpaces/Spacy/cgSolver.hh"
//#include "Spacy/ConjugateGradients/jacobipreconditioner.hh"
...
//  FunctionSpace vectorSpace(std::make_unique<Spacy<Vector> >());
...
//  auto B = makeOperator<Spacy::Test2Operator<decltype(v0)> >(vectorSpace);
...
////  auto f = Exp() - 2;
////  auto A = Spacy::makeScalarRFFGenOperator( f , R );
////    CG<double> cg(A);
