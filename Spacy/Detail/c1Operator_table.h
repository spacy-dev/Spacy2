...
namespace Spacy
{
    namespace C1OperatorDetail
    {
        ...
        template < class T >
        using TryMemFn_d1_const_Vector_ref_const_Vector_ref = decltype( std::declval< T >().d1(
        ...
        struct HasMemFn_d1_const_Vector_ref_const_Vector_ref<
            T, type_erasure_table_detail::voider<
                   TryMemFn_d1_const_Vector_ref_const_Vector_ref< T > > > : std::true_type
        {
        };

        template < class T >
        using TryMemFn_linearization_const_Vector_ref =
            decltype( std::declval< T >().linearization( std::declval< const Vector& >() ) );
        ...
        struct HasMemFn_linearization_const_Vector_ref<
            T, type_erasure_table_detail::voider< TryMemFn_linearization_const_Vector_ref< T > > >
            : std::true_type
        {
        };
