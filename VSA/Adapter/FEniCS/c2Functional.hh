...
namespace VSA
{
  namespace FEniCS
  {
    ...
    private:
      ...
      void assembleJacobian(const ::VSA::Vector& x) const
      {
      ...
      mutable ::VSA::Vector oldX_f_ = {}, oldX_J_ = {}, oldX_H_ = {};
    };
     ...
     * @param bcs Dirichlet boundary conditions
     * @param space domain space \f$X\f$
     * @return @ref C2Functional "::VSA::Fenics::C2Functional<F,DF,DDF>( f , J , H , bcs , space )"
     */
    template <class F, class DF, class DDF>
