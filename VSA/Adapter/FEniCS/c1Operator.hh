#ifndef ALGORITHM_ADAPTER_FENICS_C1_OPERATOR_HH
#define ALGORITHM_ADAPTER_FENICS_C1_OPERATOR_HH

#include <memory>

#include <dolfin.h>

#include "VSA/linearizedOperator.hh"
...
namespace VSA
{
  namespace FEniCS
  {
    ...
    public:
       ...
       */
      auto linearization(const ::VSA::Vector& x) const
      {
        primalDualIgnoreReset(std::bind(&C1Operator::assembleGradient,std::ref(*this), std::placeholders::_1),x);
        assert(A_ != nullptr);
    ...
    private:
      ...
      void assembleOperator(const ::VSA::Vector& x) const
      {
      ...
      mutable ::VSA::Vector oldX_F = {}, oldX_J = {};
    };
     ...
     * @return @ref C1Operator "::VSA::Fenics::C1Operator<ResidualForm,JacobianForm>( F , J , bcs , domain , range )"
     */
    template <class ResidualForm, class JacobianForm>
     ...
     * @return @ref C1Operator "::VSA::Fenics::C1Operator<ResidualForm,JacobianForm>( F , J , domain , range )"
     */
    template <class ResidualForm, class JacobianForm>
     ...
     * @return @ref C1Operator "::VSA::Fenics::C1Operator<ResidualForm,JacobianForm>( F , J , bcs , space , space )"
     */
    template <class ResidualForm, class JacobianForm>
...
#endif // ALGORITHM_ADAPTER_FENICS_C1_OPERATOR_HH
