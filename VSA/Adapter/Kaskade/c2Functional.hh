...
#include "VSA/hessian.hh"
#include "VSA/Util/Mixins/numberOfThreads.hh"
#include "VSA/Util/Base/functionalBase.hh"
...
namespace VSA
{
  namespace Kaskade
  {
     ...
     * @see @ref C2FunctionalAnchor "::VSA::C2Functional", @ref C2FunctionalConceptAnchor "C2FunctionalConcept"
     */
    ...
    public:
       ...
       * @return \f$f(x)\f$
       */
      double operator()(const ::VSA::Vector& x) const
      {
       ...
       */
      ::VSA::Vector d1_(const ::VSA::Vector& x) const
      {
       ...
       * @see C2FunctionalBase
       */
      ::VSA::Vector d2_(const ::VSA::Vector& x, const ::VSA::Vector& dx) const
      {
       ...
       */
      Hessian hessian(const ::VSA::Vector& x) const
      {
        primalDualIgnoreReset(std::bind(&C2Functional::assembleHessian,std::ref(*this), std::placeholders::_1),x);
    ...
    private:
      /// Assemble \f$f(x)\f$.
      void assembleFunctional(const ::VSA::Vector& x) const
      {
      ...
      void assembleGradient(const ::VSA::Vector& x) const
      {
      ...
      /// Assemble discrete representation of \f$f''(x)\f$.
      void assembleHessian(const ::VSA::Vector& x) const
      {
      ...
      mutable ::VSA::Vector old_X_f_ = {}, old_X_df_ = {}, old_X_ddf_ = {};
     ...
     * @param cbegin first column to be considered in the definition of f
     * @param cend one after the last column to be considered in the definition of f
     * @return @ref C2Functional "::VSA::Kaskade::C2Functional<FunctionalDefinition>( f, domain, rbegin, rend, cbegin, cend )"
     *
     * The optional parameters rbegin, rend, cbegin and cend can be used to define operators that correspond to parts of
     * a system of equation.
     */
