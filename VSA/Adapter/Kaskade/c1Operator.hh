#ifndef ALGORITHM_KASKADE_C1_OPERATOR_HH
#define ALGORITHM_KASKADE_C1_OPERATOR_HH
...
namespace VSA
{
  ...
  namespace Kaskade
  {
    ...
    private:
      ...
      mutable ::VSA::Vector old_X_A_ = {}, old_X_dA_ = {};
     ...
     * @return @ref C1Operator "::VSA::Kaskade::C1Operator<OperatorDefinition>( A , domain , range , rbegin , rend , cbegin , cend )"
     *
     * The optional parameters rbegin, rend, cbegin and cend can be used to define operators that correspond to parts of
     * a system of equation.
     */
...
#endif // ALGORITHM_KASKADE_C1_OPERATOR_HH
