...
//#include "VSA/ConjugateGradients/cg.hh"
//#include "FunctionSpaces/VSA/vectorSpace.hh"
//#include "FunctionSpaces/VSA/vectorSpaceElement.hh"
//#include "FunctionSpaces/VSA/cgSolver.hh"
//#include "VSA/ConjugateGradients/jacobipreconditioner.hh"
...
//  FunctionSpace vectorSpace(std::make_unique<VSA<Vector> >());
...
//  auto B = makeOperator<VSA::Test2Operator<decltype(v0)> >(vectorSpace);
...
////  auto f = Exp() - 2;
////  auto A = VSA::makeScalarRFFGenOperator( f , R );
////    CG<double> cg(A);
