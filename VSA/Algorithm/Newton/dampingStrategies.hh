...
#include "VSA/Util/Mixins/eps.hh"
#include "VSA/Util/Mixins/regularityTest.hh"
#include "VSA/Util/Concepts/Newton/dampingStrategyConcept.hh"
...
namespace VSA
{
  namespace Newton
  {
     ...
     */
    using DampingStrategy = boost::type_erasure::any< ::VSA::Concepts::Newton::DampingStrategyConcept >;
