...
namespace VSA
{
  ...
  Vector localNewton(const C1Operator& F, const Vector& x0, const VSA::Newton::Parameter p)
  {
  ...
  Vector covariantNewton(const C1Operator& F, const Vector& x0, const VSA::Newton::Parameter p)
  {
    return Newton::newton<Newton::Damping::AffineCovariant,Newton::Termination::AffineCovariant>(F,x0,p);
  }

  Vector covariantNewton(const C1Operator& F, const VSA::Newton::Parameter p)
  {
    return covariantNewton(F,F.domain().vector(),p);
  }


  Vector contravariantNewton(const C1Operator& F, const Vector& x0, const VSA::Newton::Parameter p)
  {
    return Newton::newton<Newton::Damping::AffineContravariant,Newton::Termination::AffineContravariant>(F,x0,p);
  }

  Vector contravariantNewton(const C1Operator& F, const VSA::Newton::Parameter p)
  {
