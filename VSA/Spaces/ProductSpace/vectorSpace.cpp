...
#include "VSA/Spaces/ProductSpace/scalarProduct.hh"
...
namespace VSA
{
  namespace ProductSpace
  {
    ...
    ::VSA::Vector VectorCreator::operator()(const VectorSpace* space) const
    {
      return Vector{*space};
    }
    ...
    {
      return ::VSA::makeHilbertSpace( VectorCreator{ spaces } , ScalarProduct{} );
    }
    ...
    VectorSpace makeHilbertSpace(const std::vector<std::shared_ptr<VectorSpace> >& spaces,
                                  ...
                                  const std::vector<unsigned>& dualSubSpaceIds)
    {
      return ::VSA::makeHilbertSpace( VectorCreator{ spaces , primalSubSpaceIds , dualSubSpaceIds } , ScalarProduct{} );
    }
  }
}
