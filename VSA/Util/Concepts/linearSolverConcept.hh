...
namespace VSA
{
  namespace Concepts
  {
     ...
     * @endcode
     *
     * See @ref LinearSolverAnchor "::VSA::LinearSolver", @ref CallableOperatorConceptAnchor "CallableOperatorConcept"
     */
     ...
     * @endcode
     *
     * See @ref IndefiniteLinearSolverAnchor "::VSA::IndefiniteLinearSolver".
     */
