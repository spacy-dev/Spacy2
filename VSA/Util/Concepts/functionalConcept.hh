...
namespace VSA
{
  ...
  namespace Concepts
  {
     ...
     * public:
     *   // Compute f(x).
     *   double operator()(const ::VSA::Vector&) const;
     *
     ...
     * @endcode
     *
     * See @ref FunctionalAnchor "::VSA::Functional".
     */
     ...
     * @endcode
     *
     * See @ref C1FunctionalAnchor "::VSA::C1Functional".
     */
     ...
     * See @ref C2FunctionalAnchor "::VSA::C2Functional".
     */
