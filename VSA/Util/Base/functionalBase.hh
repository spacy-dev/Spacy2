...
namespace VSA
{
  ...
  public:
     ...
     * @return \f$f'(x)\f$
     */
    ::VSA::Vector d1(const ::VSA::Vector& x) const
    {
     ...
     * @return \f$f'(x)dx\f$
     */
    double d1(const ::VSA::Vector &x, const ::VSA::Vector& dx) const
    {
      return d1(x)(dx);
    }
     ...
     * @return \f$f''(x)dx\f$
     */
    ::VSA::Vector d2(const ::VSA::Vector& x, const ::VSA::Vector& dx) const
    {
     ...
     */
    double d2(const ::VSA::Vector &x, const ::VSA::Vector &dx, const ::VSA::Vector& dy) const
    {
      return d2(x,dx)(dy);
    }
